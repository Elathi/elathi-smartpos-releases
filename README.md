...
The latest stable release is **v3.42.0** (overview refreshed 2026-09-26 UTC).
...
- [Read the current release notes](https://github.com/Elathi/elathi-smartpos-releases/releases/tag/v3.42.0)
